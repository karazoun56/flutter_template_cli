...
ButtonColors appButtonsColors(BuildContext context) => Theme.of(context).extension<ButtonColors>()!;
...
class ButtonColors extends ThemeExtension<ButtonColors> {
  ...
  @override
  ThemeExtension<ButtonColors> lerp(covariant ThemeExtension<ButtonColors>? other, double t) {
    if (other is! ButtonColors) {
      return copyWith();
    }
    return ButtonColors(
      primaryButtonBGColor: Color.lerp(primaryButtonBGColor, other.primaryButtonBGColor, t)!,
      primaryButtonFGColor: Color.lerp(primaryButtonFGColor, other.primaryButtonFGColor, t)!,
      secondaryButtonBGColor: Color.lerp(secondaryButtonBGColor, other.secondaryButtonBGColor, t)!,
      secondaryButtonFGColor: Color.lerp(secondaryButtonFGColor, other.secondaryButtonFGColor, t)!,
      dangerButtonBGColor: Color.lerp(dangerButtonBGColor, other.dangerButtonBGColor, t)!,
      dangerButtonFGColor: Color.lerp(dangerButtonFGColor, other.dangerButtonFGColor, t)!,
      disabledButtonBGColor: Color.lerp(disabledButtonBGColor, other.disabledButtonBGColor, t)!,
      disabledButtonFGColor: Color.lerp(disabledButtonFGColor, other.disabledButtonFGColor, t)!,
...
class GradientColors extends ThemeExtension<GradientColors> {
  ...
  @override
  ThemeExtension<GradientColors> lerp(covariant ThemeExtension<GradientColors>? other, double t) {
    if (other is! GradientColors) {
      return copyWith();
    }
    return GradientColors(
      scaffold: LinearGradient.lerp(scaffold, other.scaffold, t)!,
      cardLoginOrRegister: LinearGradient.lerp(cardLoginOrRegister, other.cardLoginOrRegister, t)!,
    );
  }
}
...
class SwitcherColors extends ThemeExtension<SwitcherColors> {
  ...
  @override
  ThemeExtension<SwitcherColors> lerp(covariant ThemeExtension<SwitcherColors>? other, double t) {
    ...
    return SwitcherColors(
      ...
      neutralColors: NeutralColors(
        Color.lerp(neutralColors.shade500, other.neutralColors.shade500, t)!.value,
        <int, Color>{
          40: Color.lerp(neutralColors.shade40, other.neutralColors.shade40, t)!,
          50: Color.lerp(neutralColors.shade50, other.neutralColors.shade50, t)!,
          60: Color.lerp(neutralColors.shade60, other.neutralColors.shade60, t)!,
          70: Color.lerp(neutralColors.shade70, other.neutralColors.shade70, t)!,
          80: Color.lerp(neutralColors.shade80, other.neutralColors.shade80, t)!,
          90: Color.lerp(neutralColors.shade90, other.neutralColors.shade90, t)!,
          100: Color.lerp(neutralColors.shade100, other.neutralColors.shade100, t)!,
          200: Color.lerp(neutralColors.shade200, other.neutralColors.shade200, t)!,
          300: Color.lerp(neutralColors.shade300, other.neutralColors.shade300, t)!,
          400: Color.lerp(neutralColors.shade400, other.neutralColors.shade400, t)!,
          500: Color.lerp(neutralColors.shade500, other.neutralColors.shade500, t)!,
          600: Color.lerp(neutralColors.shade600, other.neutralColors.shade600, t)!,
          700: Color.lerp(neutralColors.shade700, other.neutralColors.shade700, t)!,
          800: Color.lerp(neutralColors.shade800, other.neutralColors.shade800, t)!,
          900: Color.lerp(neutralColors.shade900, other.neutralColors.shade900, t)!,
        },
      ),
      primaryColors: PrimaryColors(
          Color.lerp(primaryColors.shade500, other.primaryColors.shade500, t)!.value, <int, Color>{
        50: Color.lerp(primaryColors.shade50, other.primaryColors.shade50, t)!,
        500: Color.lerp(primaryColors.shade500, other.primaryColors.shade500, t)!,
      }),
      blueSwitch: BlueColors(
        ...
        <int, Color>{
          ...
          1000: Color.lerp(blueSwitch.shade1000, other.blueSwitch.shade1000, t)!,
        },
      ),

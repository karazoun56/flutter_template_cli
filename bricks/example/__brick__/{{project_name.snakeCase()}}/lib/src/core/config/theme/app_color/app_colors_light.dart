...
const _primary = Color(0xFFA4E62F);
const _background = Color(0xFF212B3D);
const _white = Color(0xFFFFFFFF);
const _danger = Color(0xFFFF4337);
...
class AppColorsLight implements AppColors {
  ...
  @override
  Color get textFieldFocusBorderColor => const Color(0xFF96CE2F);

  @override
  Color get hintColor => const Color(0xFF646972);

  @override
  Color get textFieldPrefixIconColor => _neutralColors.shade300;
...
final _customButtonColors = ButtonColors(
  ...
  secondaryButtonBGColor: _background,
  secondaryButtonFGColor: _white,
  dangerButtonBGColor: _danger,
  dangerButtonFGColor: _white,
  txtButtonColor: _primary,
  disabledButtonBGColor: _neutralColors.shade400,
  disabledButtonFGColor: _neutralColors.shade500,
);
...
class AppGradientDark {
  static LinearGradient get _scaffold => const LinearGradient(

...
extension LogRecordX on LogRecord {
  ...
  void logMessage([String? emoji]) {
    ...
    return switch (level) {
      ...
      Level.WARNING => log.w(message, time: time, error: error, stackTrace: stackTrace),
      Level.SEVERE => log.e(message, time: time, error: error, stackTrace: stackTrace),
      Level.SHOUT => log.f(message, time: time, error: error, stackTrace: stackTrace),
